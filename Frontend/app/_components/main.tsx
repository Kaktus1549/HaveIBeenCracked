...
export default function Main() {
    ...
    return(
        <main className="flex flex-col justify-center w-full min-h-full gap-2 mt-44 2xsm:gap-3 md:gap-4 xsm:mt-36 sm:mt-20 animate-slideIn opacity-0 overflow-hidden relative">
